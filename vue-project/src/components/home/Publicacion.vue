<template>
  <main class="raiz">
      <section class="raiz-public" v-for="publicacion in pulicaciones" :key="publicacion.id">
          <div class="raiz-public-content">
              <span>
                  <img src="../assets/avatar/avatar-1.png" alt="">
                  <a class="link" :href="publicacion.link_user">{{ publicacion.user }}</a>
              </span>
              <div class="raiz-public-content_interno">            
                  <iframe :src="publicacion.video_url"
                      frameborder="0"
...
<script>
  import dataPublic from "../data/public.json";
